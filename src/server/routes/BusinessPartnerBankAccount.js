...
class BusinessPartnerBankAccount {
  ...
  init() {
    ...
    this.app.get('/api/business-partners/:businessPartnerId/bank_accounts', (req, res) => this.index(req, res));
    ...
    this.app.post('/api/business-partners/:businessPartnerId/bank_accounts', (req, res) => this.create(req, res));
    ...
    this.app.get('/api/business-partners/:businessPartnerId/bank_accounts/:bankAccountId', (req, res) => this.show(req, res));
    ...
    this.app.put('/api/business-partners/:businessPartnerId/bank_accounts/:bankAccountId', (req, res) => this.update(req, res));
    ...
    this.app.delete('/api/business-partners/:businessPartnerId/bank_accounts/:bankAccountId', (req, res) => this.delete(req, res));
  }
